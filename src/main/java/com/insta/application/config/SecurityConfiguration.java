...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
				http.csrf().disable()
						...
						.authorizeRequests().antMatchers("/insta/login","/insta/nonadminlogin","/insta/forgotpassword","/insta/extemail","/extemail","/**.html","/styles/**","/*.jpg","/assets/pages/scripts/**").permitAll()
